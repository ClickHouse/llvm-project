...
/// This class provides a base template for std::char_traits with unknown types. As per the standard,
/// only char, wchar_t, char8_t, char16_t, char32_t must be explicitly specialized by the standard
/// library. As a result, libcxx 19 removed the base template which broke lots of code in ClickHouse.
/// Migrating this code is not straightforward, therefore restore the base template for now...
template <class _CharT>
